...
-- Configuration
INSERT INTO CONFIGURATION(ENTRY_KEY, ENTRY_VALUE) VALUES('MAIL_SERVER', 'smtp.gmail.com'); -- Dev
--INSERT INTO CONFIGURATION(ENTRY_KEY, ENTRY_VALUE) VALUES('MAIL_SERVER', 'localhost');      -- Test
INSERT INTO CONFIGURATION(ENTRY_KEY, ENTRY_VALUE) VALUES('MAIL_PORT', '465');
...
INSERT INTO CONFIGURATION(ENTRY_KEY, ENTRY_VALUE) VALUES('MAIL_PROTOCOL', 'smtps');
...
INSERT INTO PKIRAUSER (USER_ID, LAST_NAME, FIRST_NAME, NATIONAL_REGISTER_NUMBER, IS_ADMIN, ADMIN_EMAIL, ADMIN_EMAIL_REGISTRATION) VALUES(7003, 'Test', 'User', '99999999999', 1, 'j.vandenbergh@aca-it.be', 1);
...
INSERT INTO CONTRACT(CONTRACT_ID, TYPE, CONTRACT_DOCUMENT, SUBJECT, REQUESTER, CERTIFICATE_DOMAIN_ID, CREATION_DATE, RESULT, CERTIFICATE_TYPE) VALUES(9001, 'Sign', '<signing/>', 'c=be,o=fedict', 'Pietje Puk', 6001, '2011-10-17 20:55:00', 'SUCCESS', 'CLIENT');
INSERT INTO CONTRACT(CONTRACT_ID, TYPE, CONTRACT_DOCUMENT, SUBJECT, REQUESTER, CERTIFICATE_DOMAIN_ID, CREATION_DATE, RESULT, CERTIFICATE_TYPE) VALUES(9002, 'Revoke', '<revocation/>', 'c=be,o=fedict', 'Pietje Puk', 6001, '2011-10-17 21:55:00', 'INVALID_MESSAGE', null);
INSERT INTO CERTIFICATE(CERTIFICATE_ID, SERIAL_NUMBER, X509, DISTINGUISHED_NAME, VALIDITY_START, VALIDITY_END, REQUESTER, ISSUER, CERTIFICATE_TYPE, CERTIFICATE_DOMAIN_ID) VALUES(10001, 12345, 'abcdefg', 'c=be,o=fedict', '2011-10-17 20:55:00', '2012-10-17 20:55:00', 'Pietje Puk', 'Issuer Test', 'CLIENT', 6001)
