...
INSERT INTO CA_PARAMETERS(CA_CA_ID, mapkey, element) VALUES (5001, 'signing.keystore.url', 'file:/Users/jan/Projects/Fedict/eid-pki-ra/eid-pki-ra/eid-pki-ra-client-xkms/target/test-classes/test.jks'); -- Dev
...
-- Users
INSERT INTO USER (USER_ID, LAST_NAME, FIRST_NAME, NATIONAL_REGISTER_NUMBER, IS_ADMIN) VALUES(7001, 'Van den Bergh', 'Jan', '74081447338', 1);
--INSERT INTO USER (LAST_NAME, FIRST_NAME, NATIONAL_REGISTER_NUMBER, IS_ADMIN) VALUES('Gistelinck', 'Katrien', '75050706079', 1);
--INSERT INTO USER (LAST_NAME, FIRST_NAME, NATIONAL_REGISTER_NUMBER, IS_ADMIN) VALUES('Beyl', 'Bert', '73111237304', 1);
--INSERT INTO USER (LAST_NAME, FIRST_NAME, NATIONAL_REGISTER_NUMBER, IS_ADMIN) VALUES('Van Wilder', 'Kevin', '86011736367', 1);
--INSERT INTO USER (LAST_NAME, FIRST_NAME, NATIONAL_REGISTER_NUMBER, IS_ADMIN) VALUES('Van Den Eynde', 'Sam', '77102825708', 1);
--INSERT INTO USER (LAST_NAME, FIRST_NAME, NATIONAL_REGISTER_NUMBER, IS_ADMIN) VALUES('Cornelis', 'Frank', '79102520991', 1);
--INSERT INTO USER (LAST_NAME, FIRST_NAME, NATIONAL_REGISTER_NUMBER, IS_ADMIN) VALUES(7001, 'Test', 'User', '99999999999', 1);
