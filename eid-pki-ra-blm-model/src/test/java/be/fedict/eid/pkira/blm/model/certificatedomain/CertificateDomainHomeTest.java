...
public class CertificateDomainHomeTest extends SeamTest {
	...
	private CertificateDomainHome home;
	...
	@BeforeClass
	public void setup() {
		home = new CertificateDomainHome();
...
//		CertificateDomain certificateDomain = home.findByDnExpression(DN_EXPRESSION);
//		assertEquals(certificateDomain, valid);
//	}
//
//	@Test(dependsOnMethods = "persist")
...
//		}
//		List<CertificateDomain> domains = home.findByCertificateTypes(certificateTypes);
