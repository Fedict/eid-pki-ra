...
public class SetupBulkDatabase extends SetupDatabase {
	...
	private StringBuilder generateConfigurationEntrySQL() {
		return new StringBuilder()
				...
				.append("INSERT INTO CONFIGURATION (ENTRY_KEY, ENTRY_VALUE) VALUES('DSS_WS_LOCATION', 'e');\n");
	}
	...
	private Object generateCeritficateDomainSQL() {
		...
		for (int i = 0; i < 150; i++) {
			...
			builder.append("INSERT INTO CertificateDomain (CERTIFICATE_DOMAIN_NAME, DN_EXPRESSION, CLIENTCERT, SERVERCERT, CODECERT) VALUES ('Name")
					.append(sequence)
					.append("', 'DN")
					.append(sequence)
					.append("', 1, 0, 1);\n");
