...
@NamedQueries(value = @NamedQuery(name = ConfigurationEntry.NQ_SELECT_ALL, query = "SELECT key, value FROM ConfigurationEntry"))
public class ConfigurationEntry {

	public static final String NQ_SELECT_ALL = "selectConfigurationEntries";
