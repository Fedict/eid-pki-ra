...
import be.fedict.eid.pkira.portal.domain.AbstractDSSSigningWrapper;
 ...
 *
 */
public abstract class AbstractDSSPreSigningHandler<T extends AbstractDSSSigningWrapper<? extends AbstractContract>> implements DSSPreSigningHandler {
